...
$S3_TOKEN = "オブジェクトストレージのアクセスキーIDを設定してください"
$S3_SECRET = "オブジェクトストレージのシークレットアクセスキーを設定してください"
$S3_INPUT_BUCKET = "画像入力用バケット名を設定してください"
$S3_OUTPUT_BUCKET = "画像出力用バケット名を設定してください"
